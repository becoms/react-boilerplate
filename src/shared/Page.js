...
export const PageTitle = ({ as: Component = "h1", ...props }) => {
  return (
    <Component
      tw="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:leading-9 sm:truncate"
      {...props}
    />
  );
};
...
export const PageSkeleton = () => {
  return (
    <Page
      ...
      title={
        <PageTitle as="div" tw="h-6 sm:h-8 my-1 mt-3 bg-gray-200 w-1/3 rounded-md animate-pulse" />
      }
    >
      <Panel>
        <div tw="h-96" />
