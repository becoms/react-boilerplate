    ...
    <>
      ...
      <main tw="flex-1 relative overflow-y-auto py-6 max-w-7xl w-full mx-auto px-4 sm:px-6 md:px-8 py-6 flex flex-col items-center">
        ...
        <svg tw="mt-16 sm:mt-24 md:mt-32 max-w-sm mx-auto flex-shrink-0" viewBox="0 0 1121 778">
          <circle cx="212.6" cy="103" r="64" tw="fill-current text-indigo-400 dark:text-indigo-300" />
          <path
            tw="fill-current text-indigo-300 dark:text-indigo-400"
        ...
        <h1 tw="text-xl leading-6 font-medium text-gray-900 dark:text-white text-center mt-16">
          {t("NotFound.title")}
        </h1>
        <p tw="max-w-lg text-sm leading-5 text-gray-500 dark:text-gray-400 text-center mt-2">
          {t("NotFound.description")}
        </p>
        <span tw="inline-flex rounded-md shadow-sm mt-8">
          <Link
            to="/"
            tw="inline-flex items-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-indigo-600 dark:bg-indigo-500 hover:bg-indigo-500 dark:hover:bg-indigo-400 focus:outline-none focus:border-indigo-700 dark:focus:border-indigo-600 focus:shadow-outline-indigo active:bg-indigo-700 dark:active:bg-indigo-600 transition ease-in-out duration-150"
          >
