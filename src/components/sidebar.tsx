    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={twMerge(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar-accent flex min-h-svh w-full",
            className
          )}
          {...props}
        >
...
function Sidebar({
  ...
  return (
    <div
      className="group peer bg-sidebar-accent text-sidebar-foreground"
      data-state={state}
...
function SidebarInput({
  ...
  return (
    <Input
      ...
      data-sidebar="input"
      className={twMerge("bg-background h-8 w-full shadow-none", className)}
      {...props}
    />
  );
}
